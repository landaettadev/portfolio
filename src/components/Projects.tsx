...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'Multi-purpose website developed in CodeIgniter (PHP + MySQL) for SMM services promotion and management. Includes provider API consumption and multiple payment gateway integration.',
